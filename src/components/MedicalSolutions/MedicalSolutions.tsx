...
const MedicalSolutions = () => {
  return (
    <section className="medical-solutions bg-light-green py-16 px-8 flex flex-col lg:flex-row items-center lg:items-start">
      {/* Left Section: Text Content */}
      <div className="text-content lg:w-1/2 lg:mr-12 mb-8 lg:mb-0">
        <p className="text-green text-sm uppercase mb-2">Highest Quality Care</p>
        <h2 className="text-4xl font-bold text-dark-green mb-6">Solutions to Complex Medical Problems</h2>
        <ul className="text-green list-disc pl-4 space-y-4">
